...
def upgrade() -> None:
    ...
    op.create_index("ix_scan_jobs_archive_status", "scan_jobs_archive", ["status"], unique=False)
    op.create_index("ix_scan_jobs_archive_archived_at", "scan_jobs_archive", ["archived_at"], unique=False)
    op.create_index("ix_scan_jobs_archive_created_at", "scan_jobs_archive", ["created_at"], unique=False)
    op.create_index("ix_scan_jobs_archive_original_id", "scan_jobs_archive", ["original_scan_job_id"], unique=False)
    op.create_index("ix_scan_jobs_archive_job_id", "scan_jobs_archive", ["job_id"], unique=False)
